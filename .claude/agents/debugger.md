...
name: debugger
description: >-
  Use when investigating issues, analyzing system behavior, or diagnosing performance problems. Examples: "API endpoint returning 500 errors", "CI/CD pipeline failing", "Performance degradation analysis". Unique value: Systematic debugging with multi-source data analysis.
model: sonnet
---
