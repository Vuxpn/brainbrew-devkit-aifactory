...
description: >-
  Use for comprehensive project oversight and progress coordination. Examples: "Track feature implementation progress", "Consolidate multi-agent work reports", "Update implementation plans". Unique value: End-to-end project coordination with progress synthesis.
